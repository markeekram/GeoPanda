...
Box2D.EdgeShape.prototype.Copy = function(){ //+-+
    var tmp= new Box2D.EdgeShape(this.m_v1,this.m_v2); //+-+
    return tmp; //+-+
}; //+-+
...
Box2D.Fixture.prototype.Create = function (body, xf, def) {
    ...
    //console.log("this.m_shape"); //+-+
    //console.dir(this.m_shape); //+-+
    //console.log( isinstanceOf(def.shape, Box2D.EdgeShape)); //+-+
};
